const footerSections = [
  {
    title: "회사소개",
    links: ["소개", "채용", "광고문의", "문의하기", "이용약관", "개인정보처리방침", "쿠키 정책"],
  },
  {
    title: "서비스",
    links: ["프로", "무료 도구", "포트폴리오", "차트", "스크리너", "웹마스터 도구"],
  },
  {
    title: "시장",
    links: ["주식", "지수", "외환", "원자재", "암호화폐", "채권", "ETF", "펀드"],
  },
  {
    title: "더보기",
    links: ["뉴스", "분석", "기술적 분석", "경제 캘린더", "실적 캘린더", "브로커 리뷰"],
  },
];
      ...
      <div className="max-w-[1260px] mx-auto px-4 py-10">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mt-10 pt-8 border-t border-white/10">
          <div className="flex items-center gap-4 mb-4 sm:mb-0">
            <span className="text-sm text-gray-500">팔로우:</span>
          ...
          <div className="flex gap-3">
            ...
            >
              ...
              <div className="text-left">
                <div className="text-[10px] text-gray-400 leading-none">다운로드</div>
        ...
        <div className="max-w-[1260px] mx-auto px-4 py-5">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <p className="text-xs text-gray-500 max-w-2xl leading-relaxed">
              위험 고지: 금융상품 및/또는 암호화폐 거래는 투자 금액의 일부 또는 전부를 잃을 수 있는 높은 위험을 포함하며, 모든 투자자에게 적합하지 않을 수 있습니다. 암호화폐 가격은 매우 변동성이 높으며 금융, 규제 또는 정치적 사건 등 외부 요인의 영향을 받을 수 있습니다.
            </p>
          </div>
